...
import { LoginFormData } from "@/lib/types/auth.type";
    ...
    <section className="relative flex flex-wrap lg:h-screen lg:items-center bg-white dark:bg-black/90">
      <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24">
        ...
        <form
          ...
          className="mx-auto mb-0 mt-8 space-y-4 text-black max-w-lg"
        >
          <AuthForm
            label="Email"
            name="email"
          ...
          />
          <AuthSubmit name="Login" isLoading={state === "submitting"} />
        </form>
      </div>
